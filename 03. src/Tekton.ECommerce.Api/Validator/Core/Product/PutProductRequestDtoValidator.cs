...
{
    public class PutProductRequestDtoValidator : AbstractValidator<PutProductRequestDto>
    {
        ...
        public PutProductRequestDtoValidator()
        {
            ...
            RuleFor(x => x.IsActive)
              .Cascade(CascadeMode.Stop)
              .NotNull().WithMessage(GlobalMessages.Required.Core.ProductRequired.IsActive)
              ;
