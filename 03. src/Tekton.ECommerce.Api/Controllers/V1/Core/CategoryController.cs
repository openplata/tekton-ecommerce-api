...
namespace Tekton.ECommerce.Api.Controllers.V1.Core
{
    ...
    public class CategoryController : BaseAuthController
    {
        ...
        ///         <td>
        ///             <ul>
        ///	                <li>El [categoryName] debe ser mínimo de 3 y máximo de 50 caracteres.</li>
        ///	                <li>Valores solo letras y números , sino cumple => El [categoryName] debe contener sólo letras y números.</li>
        ///	            </ul>
        ///	        </td>
        ///     </tr>
        ///     <tr>
        ...
        [HttpPost]        
        [SwaggerOperation(Tags = new[] { "Núcleo - Categorías" }, Summary = "Registrar categorías", OperationId = "PostCategoryRequest")]
        ...
        ///         <td>
        ///             <ul>
        ///	                <li>El [categoryId] de ser número.</li>
        ///	                <li>Solo números mayor o igual a cero, sino cumple => El [categoryId] debe ser mayor a cero.</li>
        ///	            </ul>
        ///	        </td>
        ///     </tr>
        ///     <tr>
        ...
        ///	                <li>Solo números mayor o igual a cero, sino cumple => El [parentId] debe ser igual o mayor a cero.</li>
        ///	            </ul>
        ///	        </td>
        ///     </tr>
        ///     <tr>
        ...
        /// <response code="400">Solicitud con inconsistencias.</response>        
        [HttpPut]
        [SwaggerOperation(Tags = new[] { "Núcleo - Categorías" }, Summary = "Actualizar categorías", OperationId = "PutCategoryRequest")]
        [Produces("application/json")]
        ...
        /// <response code="400">Solicitud con inconsistencias.</response>        
        [HttpGet("get-by-id")]
        [SwaggerOperation(Tags = new[] { "Núcleo - Categorías" }, Summary = "Obtener categorías", OperationId = "GetCategoryByIdRequestDto")]
        [Produces("application/json")]
        ...
        [SwaggerOperation(Tags = new[] { "Núcleo - Categorías" }, Summary = "Obtener ítems por parentId", OperationId = "GetCategoryAllByParentIdRequestDto")]
        [Produces("application/json")]
